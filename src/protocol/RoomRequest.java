...
public class RoomRequest {
     ...
     * Represents a request to leave a room
     */
    public static class GetUsersInRoomRequest extends RoomRequest implements Request {

        /**
         * Creates a new GetUsersInRoomRequest request object
         * @param username the username of the user of the request/response
         * @param roomName the name of the room
         */
        public GetUsersInRoomRequest(String username, String roomName) {
            super(username, roomName);
        }
        ...
        /**
         * Gets the String representation of the GetUsersInRoomRequest object
         * @return the String representation of the GetUsersInRoomRequest object
         */
        @Override
        public String toString() {
            return "GetUsersInRoomRequest [" + super.toString() + "]";
        }
        
        /**
         * Checks if a GetUsersInRoomRequest object is equal to another object
         * @param obj the object to compare to
         * @return true if equal, else false
         */
        @Override
        public boolean equals(Object obj) {
            ...
            if (getClass() != obj.getClass())
                return false;
            GetUsersInRoomRequest other = (GetUsersInRoomRequest) obj;
            if (getRoomName() == null) {
                if (other.getRoomName() != null)
                    return false;
            } else if (!getRoomName().equals(other.getRoomName()))
